package com.supply.carrier.entity;
 ...
 * @date 2016-07-24 21:06:25
 * @version V1.0   
 *
 */
@Entity
@Table(name = "bd_carrier", schema = "")
@SuppressWarnings("serial")
public class BdCarrierEntity implements java.io.Serializable {
	/**主键*/
	...
	private java.lang.String fathercarrier;
	 ...
	 */
	@Column(name ="CARRIERNAME",nullable=true,length=200)
	...
	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  上级单位名称
	 */
	public void setFathercarrier(java.lang.String fathercarrier){
		this.fathercarrier = fathercarrier;
	}
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  上级单位名称
	 */
	@Column(name ="FATHERCARRIER",nullable=true,length=200)
	public java.lang.String getFathercarrier(){
		return this.fathercarrier;
	}
	 ...
	 *@return: java.lang.String  创建人名称
	 */
	@Column(name ="BSEALFLAG",nullable=true,length=50)
