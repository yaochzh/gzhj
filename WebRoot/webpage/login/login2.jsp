...
<div align="center" class="container loginBg">
    ...
    <div class="login">
    	<ul class="titleName">
        	<li class="english">自助平台</li>
            <li class="chinese">自助平台</li>
        </ul>
        <ul class="loginInfo">
            <li>
	            <span>用户名：</span>
    ...
    <div class="copyright ">
    	<span>&copy; 自助平台 版权所有 <span class="tip"><a href="#" title=自助平台 自助平台>自助平台</a> (推荐使用IE8+,谷歌浏览器) 技术支持：:<a href="#" title=自助平台 自助平台>自助平台</a></span></span>
    </div>       
</div>
</form>
