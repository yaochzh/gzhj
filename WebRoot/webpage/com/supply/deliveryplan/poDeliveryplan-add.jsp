		...
		<table cellpadding="0" cellspacing="1" class="formtable">
			<tr>
				...
				<td class="value"><input id="expiredate" name="expiredate"
					type="text" style="width: 150px" class="Wdate" type="date" onClick="WdatePicker()" datatype="*" pattern="yyyy-MM-dd" 
			...
			<tr>
				...
				<td class = "value"><input id="createDate" name="createDate"
					type="text" style="width: 150px" class="Wdate"  type="date" pattern="yyyy-MM-dd" readOnly="true" 
				<span class="Validform_checktip"></span> <label class="Validform_label" style="display: none;">单据日期</label>
				</td>
				<td align="right"><label class="Validform_label">承运单位:</label></td>
				...
				<span class="Validform_checktip"></span> <label class="Validform_label" style="display: none;">承运单位</label>
				</td>
				
				<td align="right"><label class="Validform_label"></label></td>
				<td class = "value">
				<span class="Validform_checktip"></span> <label class="Validform_label" style="display: none;"></label>
				</td>
			</tr>
		</table>
		...
		<tbody id="add_poDeliveryplanB_table_template">
			<tr>
			 ...
			 <input id = "poDeliveryplanBList[#index#].vehiclelicense"
					name="poDeliveryplanBList[#index#].vehiclelicense" type="text" class="inputxt" maxlength="32" style="width:120px;" readOnly="true"> <label
					class="Validform_label" style="display: none;">车牌号</label>    
				...
				<td align="left" width = "126px"><input
					...
					type="text" class="inputxt" style="width:120px;" datatype = "*" readOnly="true" >      <label
				...
				<td align="left"><input
					...
					type="text" class="inputxt" style="width:120px;" datatype="*"  readOnly="true" errormsg="该字段不为空"> <label
				...
				<td align="left"><input
					...
					type="text" class="inputxt" style="width:120px;" datatype="m" readOnly="true" errormsg="请输入正确的手机号"> <label
				...
				<td align="left"><input
					...
					type="text" class="inputxt" style="width:120px;"  readOnly="true"> <label
