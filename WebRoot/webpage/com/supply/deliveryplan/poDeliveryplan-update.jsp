		...
		<table cellpadding="0" cellspacing="1" class="formtable">
			...
			<tr>
				...
				<td class="value"><input id="unloadplace" name="unloadplace"
					type="text" style="width: 150px" class="inputxt"
					value='${poDeliveryplanPage.unloadplace}' > <span
					class="Validform_checktip"></span> <label class="Validform_label"
				...
				<td class="value"><input id="store" name="store" type="text"
					style="width: 150px" class="inputxt"
					value='${poDeliveryplanPage.store}' > <span
					class="Validform_checktip"></span> <label class="Validform_label"
			...
			<tr>
				...
				<td class="value"><t:dictSelect field="carrier" type="list" dictCondition = "fuck" dictTable="bd_carrier" dictField="carriername" dictText="carriername" defaultVal="${poDeliveryplanPage.carrier}" hasLabel="false"  title="承运单位"></t:dictSelect>
					
					<span
					class="Validform_checktip"></span> <label class="Validform_label"
					style="display: none;">承运单位</label></td>--%>
					<td align="right"><label class="Validform_label">到期日期:</label>
				</td>
				<td class="value"><input id="expiredate" name="expiredate"
					type="text" style="width: 150px" class="Wdate" onClick="WdatePicker()" datatype="*"
				...
				<td class="value"><input id="vnote" name="vnote" type="text"
					style="width: 150px" class="inputxt"
					value='${poDeliveryplanPage.vnote}'> <span
					class="Validform_checktip"></span> <label class="Validform_label"
			...
			<tr>
				...
				<td class="value"><t:dictSelect id="carrier" field="carrier" type="list"  dictCondition = "fuck"
									dictTable="bd_carrier" dictField="id" dictText="carriername" defaultVal="${poDeliveryplanPage.carrier}" hasLabel="true"  title="承运单位"></t:dictSelect>    
					<span class="Validform_checktip"></span> <label
		...
		<tbody id="add_poDeliveryplanB_table_template">
			<tr>
				...
				<input id="poDeliveryplanBList[#index#].vehiclelicense"
					...
					<label class="Validform_label" style="display: none;">车牌号</label></td>
				<td align="left"><input id="poDeliveryplanBList[#index#].drivername"
					name="poDeliveryplanBList[#index#].drivername" maxlength="32"
					type="text" class="inputxt" style="width:120px;" datatype = "*" readOnly="true">
