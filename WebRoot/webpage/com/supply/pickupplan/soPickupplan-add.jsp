...
<html>
	  ...
	  var soordercode = document.getElementById("soordercode").value;
	   ...
	   if(!(planassnum > 0)) {
	  	...
	  	$.ajax({
	  		type : "POST",
	  		async:false, 
	  		url : "soPickupplanController.do?checkPlanassnum&planassnum="+planassnum+"&soordercode="+soordercode+"&soordernum="+soordernum+"",// 请求的action路径
	  		error : function() {// 请求失败处理函数
	  	...
	  	if(isFlag == 1) {
	  		$.messager.alert('错误', "计划量超订单量！");  
	  		return false;
	  	}

	  document.getElementById("surplusnum").value = planassnum;
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="soPickupplanController.do?doAdd"  beforeSubmit="checkvehicle()">
					...
					<input id="soordernum" name="soordernum" type="hidden" value="${soPickupplanPage.soordernum }">
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			<td align="right">
				<label class="Validform_label">计划分配量</label>
			</td>
			<td class="value">
		      <input id="planassnum" name="planassnum" onchange="checkPlanassnum()" type="text" style="width: 150px" class="inputxt"  value='${soPickupplanPage.planassnum}'  >
				<span class="Validform_checktip"></span>
				<label class="Validform_label" style="display: none;">计划分配量</label>
			</td>
		...
		<tr>
			...
			<td class="value">
		      <t:dictSelect id ="carrier"  field="carrier" type="list"
	...
	<tbody id="add_soPickupplanB_table_template">
		<tr>
			 ...
			 <td align="center"><input style="width:20px;" type="checkbox" name="ck"/></td>
				  ...
				  <input id ="soPickupplanBList[#index#].vehiclelicense"  name="soPickupplanBList[#index#].vehiclelicense" maxlength="32" 
				  ...
				  <td align="left">
					  	<input id="soPickupplanBList[#index#].loadnum" name="soPickupplanBList[#index#].loadnum" maxlength="9"  readOnly="true"
